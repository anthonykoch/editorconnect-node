...
var isReply = function isReply(message) {
  ...
  return message && isFilled(message.id) && (0, _isLength.default)(message.iid) && isFilled(message === null || message === void 0 ? void 0 : (_message$origin = message.origin) === null || _message$origin === void 0 ? void 0 : _message$origin.id) && (0, _isLength.default)(message.part) && typeof message.done === 'boolean' && isFilled(message === null || message === void 0 ? void 0 : (_message$to = message.to) === null || _message$to === void 0 ? void 0 : _message$to.id) && isFilled(message === null || message === void 0 ? void 0 : (_message$to2 = message.to) === null || _message$to2 === void 0 ? void 0 : _message$to2.event);
};
/**
...
var isCall = function isCall(message) {
  ...
  return message && message.type === 'call' && isFilled(message.id) && (0, _isLength.default)(message.iid) && isFilled(message.event) && message.hasOwnProperty('payload') && isFilled((_message$origin2 = message.origin) === null || _message$origin2 === void 0 ? void 0 : _message$origin2.id);
};
/**
...
var isHandshake = function isHandshake(message) {
  ...
  return message && message.type === 'handshake' && isFilled(message.id) && isFilled((_message$origin3 = message.origin) === null || _message$origin3 === void 0 ? void 0 : _message$origin3.id) && message.hasOwnProperty('payload');
};
/**
...
var isHandshakeAccept = function isHandshakeAccept(message) {
  ...
  return message && message.type === 'handshake-accept' && isFilled(message.id) && isFilled((_message$origin4 = message.origin) === null || _message$origin4 === void 0 ? void 0 : _message$origin4.id) && isFilled((_message$to3 = message.to) === null || _message$to3 === void 0 ? void 0 : _message$to3.id) && message.hasOwnProperty('payload');
};
/**
